...
** Decriptions:         
**------------------------------------------------------------------------------------------------------
** Latest modified By:  YeYW, 2015-07-09
...
** Notice: This APIs document is only provided for the MS3390 Mobile Scanner software version of 3.4 or above.
**------------------------------------------------------------------------------------------------------
**- Listing: List the functions' simplified descriptions here
********************************************************************************************************/
#ifndef SYS_CALL_LIB_H 
#define SYS_CALL_LIB_H
...
#define MACR_CODE_TYPE_EAN13			0	 // EAN-13
#define MACR_CODE_TYPE_EAN8			1       // EAN-8
#define MACR_CODE_TYPE_UPCA			2       // UPC-A
#define MACR_CODE_TYPE_UPCE			3       // UPC-E
#define MACR_CODE_TYPE_UCCEAN128		4       // UCC/EAN 128
#define MACR_CODE_TYPE_CODE128			5       // CODE 128
#define MACR_CODE_TYPE_CODE39			6       // CODE 39
#define MACR_CODE_TYPE_CODABAR		7       // CODABAR
#define MACR_CODE_TYPE_INTL25			8       //Interleaved 2 of 5
#define MACR_CODE_TYPE_CODE93			9       // CODE93
#define MACR_CODE_TYPE_INDS25			10       //Industral 2 of 5
#define MACR_CODE_TYPE_MATR25			11       //Matrix 2 of 5
#define MACR_CODE_TYPE_CHNPST			12       //China Post
#define MACR_CODE_TYPE_CODE11			13       // CODE 11
#define MACR_CODE_TYPE_UKPL			14       //UK/Plessey
#define MACR_CODE_TYPE_MSIPL			15       // MSI/Plessey
#define MACR_CODE_TYPE_GS1DB			16       // GS1
#define MACR_CODE_TYPE_GS1LIMI			17       // GS1 Limited
#define MACR_CODE_TYPE_GS1EXPA			18       // GS1 Expanded
#define MACR_CODE_TYPE_PDF417			19       // PDF417
#define MACR_CODE_TYPE_MICPDF417		20       // MICPDF417
#define MACR_CODE_TYPE_NONE			255       //None
...
#define SECONDS_IN_DAY     86399  // seconds of one day
...
void mBeeper_SetBeeperFreq(unsigned short Period_No_Of_CCLK, unsigned short Duty);
...
unsigned char mUSB_HIDSendData(const void *DataBuf, unsigned char DataSize);
...
void mUSART1_Configure(int BaudRate);
void mUSART1_SendDataByte(char data);
void mUSART1_SendDataStr(char *dataStr, int len);
int mUSART1_ReceiveData(char *data);
